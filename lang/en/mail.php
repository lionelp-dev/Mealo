...
return [
    ...
    'workspace_invitation' => [
        ...
        'greeting' => 'Hello,',
        'message' => 'You have been invited to join a shared meal planning space on <strong>Mealo Planner</strong>.',
        'accept_button' => 'Accept invitation',
        'expires' => 'This invitation will expire on :date',
        'closing' => 'See you on Mealo!',
    ],
];
