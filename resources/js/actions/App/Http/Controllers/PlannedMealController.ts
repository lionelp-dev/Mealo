...
* @see app/Http/Controllers/PlannedMealController.php:42
* @route '/planned-meals'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:91
* @route '/planned-meals'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:107
* @route '/planned-meals/{planned_meal}'
*/
