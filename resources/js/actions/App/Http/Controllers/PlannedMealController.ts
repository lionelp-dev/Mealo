...
* @see app/Http/Controllers/PlannedMealController.php:96
* @route '/planned-meals'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:112
* @route '/planned-meals/{planned_meal}'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:132
* @route '/planned-meals'
*/
