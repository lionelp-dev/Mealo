...
* @see app/Http/Controllers/PlannedMealController.php:47
* @route '/meal-planning'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:0
* @route '/meal-planning/create'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:102
* @route '/meal-planning'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:0
* @route '/meal-planning/{planned_meal}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/meal-planning/{planned_meal}',
} satisfies RouteDefinition<["get","head"]>
...
* @see app/Http/Controllers/PlannedMealController.php:0
* @route '/meal-planning/{planned_meal}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/meal-planning/{planned_meal}/edit',
} satisfies RouteDefinition<["get","head"]>
...
* @see app/Http/Controllers/PlannedMealController.php:118
* @route '/meal-planning/{planned_meal}'
*/
...
* @see app/Http/Controllers/PlannedMealController.php:138
* @route '/meal-planning'
*/
...
/**
* @see \App\Http\Controllers\PlannedMealController::generatePlan
* @see app/Http/Controllers/PlannedMealController.php:158
* @route '/meal-planning/generate'
*/
export const generatePlan = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: generatePlan.url(options),
    method: 'post',
})
...
* @route '/meal-planning/generate'
*/
generatePlan.url = (options?: RouteQueryOptions) => {
    return generatePlan.definition.url + queryParams(options)
}
...
* @route '/meal-planning/generate'
*/
generatePlan.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: generatePlan.url(options),
    method: 'post',
})
...
* @route '/meal-planning/generate'
*/
const generatePlanForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: generatePlan.url(options),
    method: 'post',
})
...
* @route '/meal-planning/generate'
*/
generatePlanForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: generatePlan.url(options),
    method: 'post',
})

generatePlan.form = generatePlanForm

const PlannedMealController = { index, create, store, show, edit, update, destroy, generatePlan }

export default PlannedMealController