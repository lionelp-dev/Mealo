...
approve.url = (
  ...
  const parsedArgs = {
    betaRequest:
      typeof args.betaRequest === 'object'
        ? args.betaRequest.id
        : args.betaRequest,
  };
...
const BetaManagementController = { index, approve, reject, resend, cleanupAll };

export default BetaManagementController;
