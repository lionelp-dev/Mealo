...
* @see app/Http/Controllers/RecipeController.php:223
...
* @see app/Http/Controllers/RecipeController.php:255
...
* @see app/Http/Controllers/RecipeController.php:278
...
* @see app/Http/Controllers/RecipeController.php:189
...
* @see app/Http/Controllers/RecipeController.php:175
* @route '/recipes'
*/
...
* @see app/Http/Controllers/RecipeController.php:51
* @route '/recipes'
*/
...
* @see app/Http/Controllers/RecipeController.php:128
...
* @see app/Http/Controllers/RecipeController.php:155
...
const RecipeController = { showAIGenerationModal, aiGenerationPreview, aiGeneration, aiImageGeneration, image, destroy, index, create, store, edit, update }
