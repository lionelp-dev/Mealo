...
* @see app/Http/Controllers/RecipeController.php:123
...
* @see app/Http/Controllers/RecipeController.php:105
...
* @see app/Http/Controllers/RecipeController.php:221
* @route '/recipes'
*/
...
* @see app/Http/Controllers/RecipeController.php:46
* @route '/recipes'
*/
...
* @see app/Http/Controllers/RecipeController.php:69
...
* @see app/Http/Controllers/RecipeController.php:89
* @route '/recipes'
*/
...
* @see app/Http/Controllers/RecipeController.php:174
...
* @see app/Http/Controllers/RecipeController.php:201
* @route '/recipes/{recipe}'
*/
...
const RecipeController = { showAIGenerationModal, aiGeneration, aiImageGeneration, image, destroy, index, create, store, show, edit, update }
