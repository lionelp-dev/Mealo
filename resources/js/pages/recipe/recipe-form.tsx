...
export function RecipeForm({
  ...
  const defaultSubmitLabel = submitLabel || (mode === 'edit' ? t('common.buttons.update') : t('recipes.form.saveButton'));
  ...
  return (
    ...
    >
      <span className="text-md">{t('recipes.form.detailsTitle', 'Recipe details')}</span>
            ...
            return (
              <div className="flex flex-col">
                ...
                <MultiSelect
                  ...
                  placeholder={t('recipes.form.mealTimesPlaceholder', 'Select meal times...')}
                />
                <FieldInfo />
              </div>
            );
      ...
      <TagsFormSection form={form} fields={{ tags: 'tags' }} title={t('recipes.form.tagsTitle')} />
