...
export default function Recipes() {
  ...
  return RecipeFiltersDataProvider({
    data: { recipes, tags },
    children: AppLayout({
      ...
      headerRightContent: (
        <div className="flex items-center gap-7">
          ...
          >
            Multi-select <Copy size={14} className="mb-[1px]" />
          </button>
          <button
      ...
      children: (
        <>
          ...
          <div className={cn('flex h-full flex-col overflow-hidden')}>
            <RecipeFilters
              className={
                'top-0 right-0 left-0 z-10 mx-auto flex h-fit w-[92%] flex-[0_0_fit-content] justify-center overflow-hidden py-3 pb-2.5'
              }
            />
