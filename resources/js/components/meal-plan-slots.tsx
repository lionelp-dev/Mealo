...
export default function MealPlanSlots({ dayPlannedMeals }: MealPlanProps) {
  ...
  return (
    <div className="h-[60vh] rounded-lg border border-gray-200 bg-white pt-5 pb-4 shadow-sm">
      <div
        ref={scrollContainerRef}
        className="flex h-full w-full flex-col gap-4 overflow-y-scroll px-4"
      >
        <div className="flex h-full flex-col gap-2.5">
          <div className="bg-gray-25 flex flex-1 flex-col gap-3 rounded-lg border-gray-200">
