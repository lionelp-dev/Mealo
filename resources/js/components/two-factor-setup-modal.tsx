      ...
      {errors?.length ? (
        ...
        <>
          ...
          <div className="flex w-full space-x-5">
            <button className="btn w-full btn-primary" onClick={onNextStep}>
              {buttonText}
            </button>
          </div>
          ...
          <div className="relative flex w-full items-center justify-center">
            ...
            <span className="relative bg-card px-2 py-1">
              {t(
                'settings.twoFactor.setupModal.manualSetupTitle',
                'Manual Setup',
              )}
            </span>
          </div>
...
export default function TwoFactorSetupModal({
  ...
  const modalConfig = useMemo<{
    ...
    if (twoFactorEnabled) {
      return {
        title: t(
          'settings.twoFactor.setupModal.title',
          'Set up Two-Factor Authentication',
        ),
        description: t(
          'settings.twoFactor.setupModal.scanQrDescription',
    ...
    if (showVerificationStep) {
      return {
        title: t(
          'settings.twoFactor.setupModal.verifyTitle',
          'Verify Authentication Code',
        ),
        description: t(
          'settings.twoFactor.setupModal.verifyDescription',
          'Enter the 6-digit code from your authenticator app.',
        ),
        buttonText: t(
          'settings.twoFactor.setupModal.continueButton',
          'Continue',
        ),
      };
    }
