...
export function AppSidebarHeader({
  ...
  return (
    <header className="sticky top-0 z-20 flex h-fit shrink-0 items-center gap-3 border-b border-sidebar-border/50 bg-background px-3 py-3 transition-[width,height] ease-linear md:px-5 min-lg:gap-6">
