  ...
  return (
    ...
    >
      {canPlanMeal && (
        <button
          type="button"
          className="group flex h-full w-full cursor-pointer items-center justify-center gap-2 rounded-xl border border-dashed border-base-300 bg-base-100/80 px-4 py-4 text-sm font-medium text-gray-500 transition-all duration-200 ease-in-out hover:border-primary hover:bg-primary/10 hover:text-primary"
