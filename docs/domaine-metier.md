...
Les limites actuelles des fonctionnalités IA, notamment la personnalisation du planning et les différences de transport entre générations, doivent rester formulées précisément dans la documentation et les supports de présentation.
...
[Sommaire](../README.md#sommaire) | [Modélisation des données](modelisation-donnees.md)
